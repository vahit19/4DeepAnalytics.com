...
touristy = {"0":"https://livestream.ibb.gov.tr/ibb_live/anadoluhisarihq.stream/chunklist_w520532298.m3u8",
...
city = {"0":"http://ibb-media1.ibb.gov.tr:1935/live/223.stream/chunklist_w1088399288.m3u8", #mecidiyeköy
...
kameraturu = int(input("What type of camera do you want to use?\n (1)Tourist Camera\n (2) City and Traffic Cameras\n "))

def selected():
	if(kameraturu == 1):
		turkamsec  = str(input("Select the Camera you want to process\n(0)Anadolu Hisarı\n (1)Bağdat Caddesi \n(2)Bağdat Caddesi 2 \n(3)Beyazit Kulesi\n(4)Beyazit Meydan \n(5)Büyük Çamlıca \n(6)Dragos\n(7)Emirgan \n(8)Galata Kulesi\n(9)Hidiv Kasrı 1 \n(10)Hidiv Kasrı 2 \n(11)Kadıköy \n(12)Karaköy \n(13)Kapalı Çarşı \n(14)Kız Kulesi \n(15)Küçük Çamlıca\n(16)Metrohan \n(17)Mısır Çarşısı \n(18)Miniatürk \n(19)Pierre Loti \n(20)Salacak \n(21)Saraçhane \n(22)Sepetçiler Kasrı \n(23)Sultanahmet \n(24)Taksim \n(25)Ulus Parkı \n(26)İstiklal Caddesi 1\n(27)İstiklal Caddesi 2\n "))
		secilikamera = touristy[turkamsec]
		return secilikamera
	elif(kameraturu == 2):
		turkamsec = str(input("Choose the camera you want to process\n(0)Mecidiyeköy\n(1)FSM Köprüsü\n(2)268-s yolu asiyan\n(3)Beşiktaş\n(4)sirkeci\n(5)Acıbadem Köprüsü\n(6)Kadıköy Rıhtım\n(7)Kağıthane\n(8)Çavuşbaşı\n(9)Dünya Gazetesi\n(10)Atatürk Havalimanı\n(11)15 temmuz şehitler köprüsü\n(12)Taksim Bahçe\n(13)Eyüp Feshane\n(14)harem ido\n(15)H.U Tuneli Beykoz\n"))
		secilikamera = city[turkamsec]
		return secilikamera
